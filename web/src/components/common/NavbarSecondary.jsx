...
const NavbarSecondary = () => {
  ...
  return (
    <div className="bg-indigo-50 z-50 w-full">
        ...
        <div className="flex justify-between h-10">
          <div className="flex my-auto">
            <a
              ...
              target="_blank"
            >
              <i className="fas fa-envelope mr-3 text-yellow-500 hover:text-white"></i>
              <span className="text-gray-800 hover:text-yellow-700 text-sm font-thin ">
          ...
          <div className="flex my-auto">
            <a
              ...
              target="_blank"
            >
              <i className="fas fa-map-marker-alt mr-3 text-yellow-500 hover:text-white"></i>
              <span className="text-gray-800 hover:text-yellow-700 text-sm font-thin ">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            <a href="tel:+15087470744">
              <i className="fas fa-phone mr-3 text-yellow-500 hover:text-white"></i>
              <span className="text-gray-800 hover:text-yellow-700 text-sm font-thin ">
                (508) 747-0744
              </span>
            </a>
