...
const ReviewSpaHome = () => {
  const data = useStaticQuery(graphql`
    query ReviewSpaHomeQ {
      imgReview: file(
        relativePath: {
          eq: "assets/images/home/spa-facial-skin-care-5-star-review-aristocracy-salon-day-spa-plymouth-ma.jpg"
        }
      ) {
        childImageSharp {
              ...
              <blockquote>
                <div>
                  ...
                  <p className="mt-6 text-2xl font-medium text-white">
                    Great staff, very pretty, very friendly, the girl who does
                    facials is amazing.
                  </p>
                </div>
                <div className="mt-6">
