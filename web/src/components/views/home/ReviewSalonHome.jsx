...
const ReviewSalonHome = () => {
  const data = useStaticQuery(graphql`
    query ReviewSalonHomeQ {
      imgReview: file(
        relativePath: {
          eq: "assets/images/home/best-salon-5-star-review-aristocracy-salon-day-spa-plymouth-ma.jpg"
        }
      ) {
        childImageSharp {
...
export default ReviewSalonHome;
